...
from flaghunter.cpa_modules.m1_api_hub.models import ProviderConfig, ProviderState, RequestLog
...
from flaghunter.llm.llm import ErrorClass, LLM
...
def _enable_m1(monkeypatch, pm: ProviderManager, tracker: CostTracker) -> None:
    monkeypatch.setattr("flaghunter.cpa_modules.m1_api_hub.is_m1_enabled", lambda: True)
    monkeypatch.setattr("flaghunter.cpa_modules.m1_api_hub.get_provider_manager", lambda: pm)
    monkeypatch.setattr("flaghunter.cpa_modules.m1_api_hub.get_cost_tracker", lambda: tracker)
    monkeypatch.setattr("flaghunter.cpa_modules.m1_api_hub.init_m1", lambda: None)
...
async def test_m1_is_lazy_initialized_when_enabled_but_not_ready(monkeypatch):
    ...
    monkeypatch.setattr("flaghunter.cpa_modules.m1_api_hub.get_provider_manager", _raise_uninitialized)
    monkeypatch.setattr("flaghunter.cpa_modules.m1_api_hub.get_cost_tracker", _raise_uninitialized)
    ...
    monkeypatch.setattr("flaghunter.cpa_modules.m1_api_hub.init_m1", _init_m1)
