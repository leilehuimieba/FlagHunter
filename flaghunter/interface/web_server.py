...
from .web_challenge_context import (
    _build_ctf_challenge_context,
    _build_ctf_resume_context,
    _derived_target_detail_source,
    _inherit_source_challenge_context,
...
from .web_session_pick import (
    _iter_session_paths,
    _pick_session_snapshot,
    _score_session_snapshot,
    _session_confidence_for_score,
)
from .web_trace_events import (
    _extract_outcome_events_from_session_context,
...
def _make_handlers(project_root: Path):
    ...
    knowledge_handlers = make_knowledge_handlers(project_root, _build_knowledge_usage)
