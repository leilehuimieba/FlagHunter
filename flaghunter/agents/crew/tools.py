...
Provide a unified summary of what was accomplished and key findings."""
    ...
    tools = [
        Tool(
            name="spawn_agent",
            description="Spawn a specialized worker agent. Use worker_type to assign focused tools: 'recon' for port/subdomain scanning, 'web' for HTTP enumeration and injection, 'exploit' for vulnerability exploitation, 'default' for general tasks.",
            schema=ToolSchema(
                type="object",
                properties={
                    "task": {
                    ...
                    "worker_type": {
                        "type": "string",
                        "enum": ["default", "web", "recon", "exploit", "crypto"],
                        "description": (
                            "Worker specialization. "
                            "'web'=dirscan/nuclei/sqlmap tools only; "
                            "'recon'=nmap/fscan/subfinder only; "
                            "'exploit'=sqlmap/afrog/pwn only; "
                            "'crypto'=pwn/crypto tools; "
                            "'default'=all tools (use when unsure)."
                        ),
                        "default": "default",
                    },
                },
