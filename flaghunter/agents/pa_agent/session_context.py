        ...
        *,
        ...
        if latest_checkpoint:
            ...
            context["latestCheckpoint"] = {
                ...
                "verifiedFlags": [record.value for record in snapshot.verified_flags],
                "runtimeFlags": [record.value for record in snapshot.runtime_flags],
                "rejectedFlags": [record.value for record in snapshot.rejected_flags],
