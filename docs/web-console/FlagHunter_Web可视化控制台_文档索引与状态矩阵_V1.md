...
|---|---|---|---|---|---|
| `FlagHunter_Web可视化控制台_StageI~III_总验收归档与交接_V2.md` | current | **是** | 否 | 是 | 当前主交接文档 / 当前 source of truth |
...
4. `D:\webstudy\FlagHunter\docs\web-console\FlagHunter_Web可视化控制台_StageIII_第二轮验证证据_V1.json`
...
1. `StageIII_第二轮状态卡_V1`
2. `StageIII_第二轮验证证据_V1.json`
3. `StageII_总验收归档_V1`
4. `StageI_收口状态卡_V1`
...
> **以后任何“当前事实判断”都不要单独依赖 planning 文档或历史阶段快照，应先看 V2 主文档，再用本矩阵判断哪些文档还有效。**
